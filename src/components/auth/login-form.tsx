...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
      {/* Google OAuth */}
      <button type="button" className="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border text-sm font-medium transition-all hover:bg-gray-50" style={{ borderColor: "#E2E8F0", color: "#0F172A" }}>
